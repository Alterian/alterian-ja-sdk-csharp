...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetClientInfo_default_response")]
    public partial class EMGetClientInfoDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetClientInfoDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetClientInfoDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), DMClient result = default(DMClient))
        {
        ...
        public DMClient Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetClientInfoDefaultResponse {\n");
