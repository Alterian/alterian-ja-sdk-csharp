...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetEMMapping_default_response")]
    public partial class GetEMMappingDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEMMappingDefaultResponse" /> class.
        /// </summary>
        ...
        public GetEMMappingDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), EMUploadMapping result = default(EMUploadMapping))
        {
        ...
        public EMUploadMapping Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEMMappingDefaultResponse {\n");
