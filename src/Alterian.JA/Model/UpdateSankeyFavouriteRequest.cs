...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpdateSankeyFavourite_request")]
    public partial class UpdateSankeyFavouriteRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSankeyFavouriteRequest" /> class.
        /// </summary>
        /// <param name="endDate">Specify a date range or the number of days in period (PeriodInDays).</param>
        /// <param name="eventTypes">Please be aware that any existing events will be replaced..</param>
        /// <param name="initiatives">Please be aware that any existing initiatives will be replaced..</param>
        /// <param name="name">name.</param>
        /// <param name="periodInDays">Filter by the last X number of days (Do not enter a start / end date).</param>
        /// <param name="queueId">queueId.</param>
        /// <param name="sankeyFavouriteId">A valid Sankey ID.</param>
        /// <param name="startDate">Specify a date range or the number of days in period (PeriodInDays).</param>
        /// <param name="userId">userId.</param>
        public UpdateSankeyFavouriteRequest(DateTime? endDate = default(DateTime?), List<string> eventTypes = default(List<string>), List<string> initiatives = default(List<string>), string name = default(string), int? periodInDays = default(int?), int queueId = default(int), int sankeyFavouriteId = default(int), DateTime? startDate = default(DateTime?), int? userId = default(int?))
        {
        ...
        /// </summary>
        /// <value>Please be aware that any existing events will be replaced.</value>
        ...
        /// </summary>
        /// <value>Please be aware that any existing initiatives will be replaced.</value>
        ...
        [DataMember(Name = "SankeyFavouriteId", EmitDefaultValue = false)]
        public int SankeyFavouriteId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SankeyFavouriteId: ").Append(SankeyFavouriteId).Append("\n");
