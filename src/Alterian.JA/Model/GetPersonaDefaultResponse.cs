...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPersona_default_response")]
    public partial class GetPersonaDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPersonaDefaultResponse" /> class.
        /// </summary>
        ...
        public GetPersonaDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Persona result = default(Persona))
        {
