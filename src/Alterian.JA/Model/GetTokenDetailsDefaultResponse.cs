...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTokenDetails_default_response")]
    public partial class GetTokenDetailsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTokenDetailsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetTokenDetailsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), CMTokenInformation result = default(CMTokenInformation))
        {
        ...
        public CMTokenInformation Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTokenDetailsDefaultResponse {\n");
