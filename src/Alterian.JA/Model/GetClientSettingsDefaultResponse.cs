...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetClientSettings_default_response")]
    public partial class GetClientSettingsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetClientSettingsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetClientSettingsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Dictionary<string, string> result = default(Dictionary<string, string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetClientSettingsDefaultResponse {\n");
