...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetLoginBrandDefault_default_response")]
    public partial class GetLoginBrandDefaultDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetLoginBrandDefaultDefaultResponse" /> class.
        /// </summary>
        ...
        public GetLoginBrandDefaultDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), int? result = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetLoginBrandDefaultDefaultResponse {\n");
