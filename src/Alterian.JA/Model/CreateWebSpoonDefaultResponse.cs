...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateWebSpoon_default_response")]
    public partial class CreateWebSpoonDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWebSpoonDefaultResponse" /> class.
        /// </summary>
        ...
        public CreateWebSpoonDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), WebSpoonStatus result = default(WebSpoonStatus))
        {
        ...
        public WebSpoonStatus Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateWebSpoonDefaultResponse {\n");
