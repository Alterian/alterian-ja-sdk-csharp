...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetEventRecords_default_response")]
    public partial class GetEventRecordsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEventRecordsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetEventRecordsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), RecordData result = default(RecordData))
        {
        ...
        public RecordData Result { get; set; }
