...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProcessStatus_default_response")]
    public partial class GetProcessStatusDefaultResponse : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProcessStatusDefaultResponse" /> class.
        /// </summary>
        ...
        public GetProcessStatusDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), ProcessStatus? result = default(ProcessStatus?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProcessStatusDefaultResponse {\n");
