...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListWebSpoon_default_response")]
    public partial class ListWebSpoonDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListWebSpoonDefaultResponse" /> class.
        /// </summary>
        ...
        public ListWebSpoonDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<WebSpoonStatus> result = default(List<WebSpoonStatus>))
        {
        ...
        public List<WebSpoonStatus> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListWebSpoonDefaultResponse {\n");
