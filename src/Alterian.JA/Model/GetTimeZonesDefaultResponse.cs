...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTimeZones_default_response")]
    public partial class GetTimeZonesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTimeZonesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetTimeZonesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Object> result = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTimeZonesDefaultResponse {\n");
