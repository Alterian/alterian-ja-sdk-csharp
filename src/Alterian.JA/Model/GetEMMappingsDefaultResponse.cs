...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetEMMappings_default_response")]
    public partial class GetEMMappingsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEMMappingsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetEMMappingsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<EMUploadMapping> result = default(List<EMUploadMapping>))
        {
        ...
        public List<EMUploadMapping> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEMMappingsDefaultResponse {\n");
