...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetUsers_default_response")]
    public partial class GetUsersDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUsersDefaultResponse" /> class.
        /// </summary>
        ...
        public GetUsersDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Object> result = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetUsersDefaultResponse {\n");
