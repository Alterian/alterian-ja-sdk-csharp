...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCurrentUser_default_response")]
    public partial class GetCurrentUserDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentUserDefaultResponse" /> class.
        /// </summary>
        ...
        /// <param name="result">A user is a unique profile of permissions and linked to a set of user login credentials.              When someone logs in using those credentials, the permissions in the user profile are applied             Each user can be logged on multiple times simultaneously.</param>
        public GetCurrentUserDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Object result = default(Object))
        {
        ...
        /// <summary>
        /// A user is a unique profile of permissions and linked to a set of user login credentials.              When someone logs in using those credentials, the permissions in the user profile are applied             Each user can be logged on multiple times simultaneously
        /// </summary>
        /// <value>A user is a unique profile of permissions and linked to a set of user login credentials.              When someone logs in using those credentials, the permissions in the user profile are applied             Each user can be logged on multiple times simultaneously</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentUserDefaultResponse {\n");
