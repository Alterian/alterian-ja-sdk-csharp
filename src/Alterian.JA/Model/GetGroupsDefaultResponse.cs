...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetGroups_default_response")]
    public partial class GetGroupsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGroupsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetGroupsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALUserGroup> result = default(List<ALUserGroup>))
        {
        ...
        public List<ALUserGroup> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetGroupsDefaultResponse {\n");
