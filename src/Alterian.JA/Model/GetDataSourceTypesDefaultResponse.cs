...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDataSourceTypes_default_response")]
    public partial class GetDataSourceTypesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDataSourceTypesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetDataSourceTypesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALDataSourceType> result = default(List<ALDataSourceType>))
        {
        ...
        public List<ALDataSourceType> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDataSourceTypesDefaultResponse {\n");
