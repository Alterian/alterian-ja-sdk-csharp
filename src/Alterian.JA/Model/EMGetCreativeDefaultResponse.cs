...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetCreative_default_response")]
    public partial class EMGetCreativeDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetCreativeDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetCreativeDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), EMDocument result = default(EMDocument))
        {
        ...
        public EMDocument Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetCreativeDefaultResponse {\n");
