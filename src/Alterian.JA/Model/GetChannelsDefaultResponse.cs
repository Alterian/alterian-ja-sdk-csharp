...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetChannels_default_response")]
    public partial class GetChannelsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetChannelsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetChannelsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Object> result = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetChannelsDefaultResponse {\n");
