...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCurrentClient_default_response")]
    public partial class GetCurrentClientDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCurrentClientDefaultResponse" /> class.
        /// </summary>
        ...
        public GetCurrentClientDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), ALClient result = default(ALClient))
        {
        ...
        public ALClient Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCurrentClientDefaultResponse {\n");
