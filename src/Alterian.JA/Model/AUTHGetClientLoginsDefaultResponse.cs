...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AUTH_GetClientLogins_default_response")]
    public partial class AUTHGetClientLoginsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AUTHGetClientLoginsDefaultResponse" /> class.
        /// </summary>
        ...
        public AUTHGetClientLoginsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<LoginInfo> result = default(List<LoginInfo>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AUTHGetClientLoginsDefaultResponse {\n");
