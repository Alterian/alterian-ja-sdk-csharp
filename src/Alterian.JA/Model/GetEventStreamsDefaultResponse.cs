...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetEventStreams_default_response")]
    public partial class GetEventStreamsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEventStreamsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetEventStreamsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<EventStream> result = default(List<EventStream>))
        {
        ...
        public List<EventStream> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEventStreamsDefaultResponse {\n");
