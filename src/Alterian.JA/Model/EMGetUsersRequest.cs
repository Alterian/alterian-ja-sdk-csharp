...
namespace Alterian.JA.Model
{
    ...
    /// EMGetUsersRequest
    /// </summary>
    [DataContract(Name = "EM_GetUsers_request")]
    public partial class EMGetUsersRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetUsersRequest" /> class.
        /// </summary>
        ...
        public EMGetUsersRequest(int eMMappingId = default(int), int eMSiteId = default(int), string eMToken = default(string))
        {
