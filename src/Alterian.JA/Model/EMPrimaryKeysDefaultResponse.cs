...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_PrimaryKeys_default_response")]
    public partial class EMPrimaryKeysDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMPrimaryKeysDefaultResponse" /> class.
        /// </summary>
        ...
        public EMPrimaryKeysDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<DMField> result = default(List<DMField>))
        {
        ...
        public List<DMField> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMPrimaryKeysDefaultResponse {\n");
