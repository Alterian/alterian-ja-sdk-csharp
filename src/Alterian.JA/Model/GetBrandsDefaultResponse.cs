...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetBrands_default_response")]
    public partial class GetBrandsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBrandsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetBrandsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALClient> result = default(List<ALClient>))
        {
        ...
        public List<ALClient> Result { get; set; }
