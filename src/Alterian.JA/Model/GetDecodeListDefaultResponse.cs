...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDecodeList_default_response")]
    public partial class GetDecodeListDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDecodeListDefaultResponse" /> class.
        /// </summary>
        ...
        public GetDecodeListDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), DecodeList result = default(DecodeList))
        {
        ...
        public DecodeList Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDecodeListDefaultResponse {\n");
