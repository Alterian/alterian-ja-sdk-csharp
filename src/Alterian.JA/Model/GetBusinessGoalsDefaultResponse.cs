...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetBusinessGoals_default_response")]
    public partial class GetBusinessGoalsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetBusinessGoalsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetBusinessGoalsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<BusinessGoal> result = default(List<BusinessGoal>))
        {
        ...
        public List<BusinessGoal> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetBusinessGoalsDefaultResponse {\n");
