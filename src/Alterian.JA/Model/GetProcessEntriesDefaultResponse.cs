...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetProcessEntries_default_response")]
    public partial class GetProcessEntriesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProcessEntriesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetProcessEntriesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALProcess> result = default(List<ALProcess>))
        {
        ...
        public List<ALProcess> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetProcessEntriesDefaultResponse {\n");
