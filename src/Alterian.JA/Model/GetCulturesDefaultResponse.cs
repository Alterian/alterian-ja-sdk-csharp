...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetCultures_default_response")]
    public partial class GetCulturesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCulturesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetCulturesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALCulture> result = default(List<ALCulture>))
        {
        ...
        public List<ALCulture> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCulturesDefaultResponse {\n");
