...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AUTH_CreateLogin_default_response")]
    public partial class AUTHCreateLoginDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AUTHCreateLoginDefaultResponse" /> class.
        /// </summary>
        ...
        public AUTHCreateLoginDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Guid result = default(Guid))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AUTHCreateLoginDefaultResponse {\n");
