...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetFoldersLazy_default_response")]
    public partial class EMGetFoldersLazyDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetFoldersLazyDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetFoldersLazyDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), EMFoldersDTO result = default(EMFoldersDTO))
        {
        ...
        public EMFoldersDTO Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetFoldersLazyDefaultResponse {\n");
