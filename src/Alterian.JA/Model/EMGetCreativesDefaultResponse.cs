...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetCreatives_default_response")]
    public partial class EMGetCreativesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetCreativesDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetCreativesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<DMCreativeDTO> result = default(List<DMCreativeDTO>))
        {
        ...
        public List<DMCreativeDTO> Result { get; set; }
