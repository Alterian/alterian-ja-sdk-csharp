...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateClient_default_response")]
    public partial class CreateClientDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClientDefaultResponse" /> class.
        /// </summary>
        ...
        public CreateClientDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), int result = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateClientDefaultResponse {\n");
