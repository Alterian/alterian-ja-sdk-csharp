...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UpsertEventStreamCustomerColumns_request")]
    public partial class UpsertEventStreamCustomerColumnsRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpsertEventStreamCustomerColumnsRequest" /> class.
        /// </summary>
        /// <param name="fields">A list of @see(EventStreamCustomerField) instances to upsert.</param>
        /// <param name="id">Id of the event stream you want to update, obtained via @see(GetEventStreams).</param>
        ...
        public UpsertEventStreamCustomerColumnsRequest(List<EventStreamCustomerField> fields = default(List<EventStreamCustomerField>), int id = default(int), string keyColumnName = default(string), string personaColumnName = default(string))
        {
            this.Fields = fields;
            this.Id = id;
        ...
        /// </summary>
        /// <value>Id of the event stream you want to update, obtained via @see(GetEventStreams)</value>
