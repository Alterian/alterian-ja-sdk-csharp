...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateEventStream_request")]
    public partial class CreateEventStreamRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEventStreamRequest" /> class.
        /// </summary>
        ...
        /// <param name="dDETarget">Target within the DDE client in which you would like to create the event stream.</param>
        /// <param name="eventStreamDatabase">Name of the engine database into which to place the event stream data.</param>
        /// <param name="groupId">ID of group to associate the event stream data with.</param>
        ...
        /// <param name="queueLockId">If the event stream is to be attached to an existing queue then the lock id must be specified. This pre-supposes that any existing consumer event stream has been deleted.</param>
        ...
        public CreateEventStreamRequest(string dDEClient = default(string), int dDESiteId = default(int), string dDETarget = default(string), string eventStreamDatabase = default(string), int? groupId = default(int?), bool isFifoQueueRequired = default(bool), string name = default(string), string project = default(string), string queueLockId = default(string), string server = default(string), bool skipDefaultQueueSetup = default(bool))
        {
        ...
        /// </summary>
        /// <value>Target within the DDE client in which you would like to create the event stream</value>
        ...
        /// </summary>
        /// <value>ID of group to associate the event stream data with</value>
        ...
        /// </summary>
        /// <value>If the event stream is to be attached to an existing queue then the lock id must be specified. This pre-supposes that any existing consumer event stream has been deleted</value>
        [DataMember(Name = "QueueLockId", EmitDefaultValue = false)]
        public string QueueLockId { get; set; }
