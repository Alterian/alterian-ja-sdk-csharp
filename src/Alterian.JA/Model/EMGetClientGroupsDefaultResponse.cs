...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetClientGroups_default_response")]
    public partial class EMGetClientGroupsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetClientGroupsDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetClientGroupsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<DMGroup> result = default(List<DMGroup>))
        {
        ...
        public List<DMGroup> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetClientGroupsDefaultResponse {\n");
