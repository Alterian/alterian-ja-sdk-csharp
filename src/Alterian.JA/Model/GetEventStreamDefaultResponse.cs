...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetEventStream_default_response")]
    public partial class GetEventStreamDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEventStreamDefaultResponse" /> class.
        /// </summary>
        ...
        public GetEventStreamDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), EventStream result = default(EventStream))
        {
        ...
        public EventStream Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEventStreamDefaultResponse {\n");
