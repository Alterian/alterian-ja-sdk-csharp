...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DeleteEventStreamCustomerColumnsFromGroup_request")]
    public partial class DeleteEventStreamCustomerColumnsFromGroupRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteEventStreamCustomerColumnsFromGroupRequest" /> class.
        /// </summary>
        /// <param name="fieldNames">A list of @see(EventStreamCustomerField) names to remove from the event stream.</param>
        /// <param name="groupId">Id of the group of event streams from which you wish to delete the attribute data.</param>
        ...
        public DeleteEventStreamCustomerColumnsFromGroupRequest(List<string> fieldNames = default(List<string>), int groupId = default(int), string keyColumnName = default(string), string personaColumnName = default(string))
        {
        ...
        /// </summary>
        /// <value>Id of the group of event streams from which you wish to delete the attribute data</value>
