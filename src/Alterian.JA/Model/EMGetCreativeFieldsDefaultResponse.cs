...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetCreativeFields_default_response")]
    public partial class EMGetCreativeFieldsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetCreativeFieldsDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetCreativeFieldsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<EMVariable> result = default(List<EMVariable>))
        {
        ...
        public List<EMVariable> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetCreativeFieldsDefaultResponse {\n");
