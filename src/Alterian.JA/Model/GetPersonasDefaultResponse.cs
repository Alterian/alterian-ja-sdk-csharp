...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPersonas_default_response")]
    public partial class GetPersonasDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPersonasDefaultResponse" /> class.
        /// </summary>
        ...
        public GetPersonasDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Persona> result = default(List<Persona>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPersonasDefaultResponse {\n");
