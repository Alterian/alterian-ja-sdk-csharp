...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPattern_default_response")]
    public partial class GetPatternDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPatternDefaultResponse" /> class.
        /// </summary>
        ...
        public GetPatternDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), Pattern result = default(Pattern))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPatternDefaultResponse {\n");
