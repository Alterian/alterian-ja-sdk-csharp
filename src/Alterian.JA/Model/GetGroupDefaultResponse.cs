...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetGroup_default_response")]
    public partial class GetGroupDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGroupDefaultResponse" /> class.
        /// </summary>
        ...
        public GetGroupDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), ALUserGroup result = default(ALUserGroup))
        {
        ...
        public ALUserGroup Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetGroupDefaultResponse {\n");
