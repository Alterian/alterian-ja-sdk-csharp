...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDataSourceItems_default_response")]
    public partial class GetDataSourceItemsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDataSourceItemsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetDataSourceItemsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<IDatasourceObject> result = default(List<IDatasourceObject>))
        {
        ...
        public List<IDatasourceObject> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDataSourceItemsDefaultResponse {\n");
