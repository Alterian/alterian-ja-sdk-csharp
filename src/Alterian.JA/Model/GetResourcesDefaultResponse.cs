...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetResources_default_response")]
    public partial class GetResourcesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetResourcesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetResourcesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<PermissionResource> result = default(List<PermissionResource>))
        {
        ...
        public List<PermissionResource> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetResourcesDefaultResponse {\n");
