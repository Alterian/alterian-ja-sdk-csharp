...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetEMServiceURL_request")]
    public partial class EMGetEMServiceURLRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetEMServiceURLRequest" /> class.
        /// </summary>
        /// <param name="eMSiteId">EM Site Id obtained from @see(GetEMMappings) or @see(GetEMMapping).</param>
        public EMGetEMServiceURLRequest(int eMSiteId = default(int))
        {
