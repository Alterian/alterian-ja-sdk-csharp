...
namespace Alterian.JA.Model
{
    ...
    /// EMLogOffRequest
    /// </summary>
    [DataContract(Name = "EM_LogOff_request")]
    public partial class EMLogOffRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMLogOffRequest" /> class.
        /// </summary>
        ...
        public EMLogOffRequest(int eMSiteId = default(int), string eMToken = default(string))
        {
