...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetClientInfo_request")]
    public partial class EMGetClientInfoRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetClientInfoRequest" /> class.
        /// </summary>
        ...
        public EMGetClientInfoRequest(int eMSiteId = default(int), string eMToken = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetClientInfoRequest {\n");
