...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AUTH_ChangePassword_default_response")]
    public partial class AUTHChangePasswordDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AUTHChangePasswordDefaultResponse" /> class.
        /// </summary>
        ...
        public AUTHChangePasswordDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), bool result = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AUTHChangePasswordDefaultResponse {\n");
