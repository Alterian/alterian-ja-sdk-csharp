...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetGroupMembers_default_response")]
    public partial class GetGroupMembersDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetGroupMembersDefaultResponse" /> class.
        /// </summary>
        ...
        public GetGroupMembersDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Object> result = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetGroupMembersDefaultResponse {\n");
