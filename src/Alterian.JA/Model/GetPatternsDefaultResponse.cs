...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPatterns_default_response")]
    public partial class GetPatternsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPatternsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetPatternsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Pattern> result = default(List<Pattern>))
        {
        ...
        public List<Pattern> Result { get; set; }
