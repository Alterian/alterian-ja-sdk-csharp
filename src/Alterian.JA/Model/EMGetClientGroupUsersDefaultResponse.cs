...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetClientGroupUsers_default_response")]
    public partial class EMGetClientGroupUsersDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetClientGroupUsersDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetClientGroupUsersDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<DMUser> result = default(List<DMUser>))
        {
        ...
        public List<DMUser> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetClientGroupUsersDefaultResponse {\n");
