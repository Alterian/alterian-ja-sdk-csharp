...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDataSourceUsers_default_response")]
    public partial class GetDataSourceUsersDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDataSourceUsersDefaultResponse" /> class.
        /// </summary>
        ...
        public GetDataSourceUsersDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<string> result = default(List<string>))
        {
