...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ColumnPublishedTransformSummary")]
    public partial class ColumnPublishedTransformSummary : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ColumnPublishedTransformSummary" /> class.
        /// </summary>
        /// <param name="columnName">Column against which the transform was applied.</param>
        ...
        public ColumnPublishedTransformSummary(string columnName = default(string), string alias = default(string), string name = default(string), string transformName = default(string), TransformType? transformType = default(TransformType?), int id = default(int), int transformId = default(int), int varVersion = default(int))
        {
        ...
        /// </summary>
        /// <value>Column against which the transform was applied</value>
