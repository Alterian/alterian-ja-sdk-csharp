...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDatasource_default_response")]
    public partial class GetDatasourceDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDatasourceDefaultResponse" /> class.
        /// </summary>
        ...
        public GetDatasourceDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), ALDataSource result = default(ALDataSource))
        {
        ...
        public ALDataSource Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDatasourceDefaultResponse {\n");
