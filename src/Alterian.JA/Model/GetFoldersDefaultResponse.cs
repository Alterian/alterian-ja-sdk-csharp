...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetFolders_default_response")]
    public partial class GetFoldersDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFoldersDefaultResponse" /> class.
        /// </summary>
        ...
        public GetFoldersDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<Folder> result = default(List<Folder>))
        {
        ...
        public List<Folder> Result { get; set; }
