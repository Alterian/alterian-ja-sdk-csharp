...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDataSourceEngineUserName_default_response")]
    public partial class GetDataSourceEngineUserNameDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDataSourceEngineUserNameDefaultResponse" /> class.
        /// </summary>
        ...
        public GetDataSourceEngineUserNameDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), string result = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDataSourceEngineUserNameDefaultResponse {\n");
