...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetPermissions_default_response")]
    public partial class GetPermissionsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPermissionsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetPermissionsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALPermission> result = default(List<ALPermission>))
        {
        ...
        public List<ALPermission> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPermissionsDefaultResponse {\n");
