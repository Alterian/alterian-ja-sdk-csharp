...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetClientSets_default_response")]
    public partial class GetClientSetsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetClientSetsDefaultResponse" /> class.
        /// </summary>
        ...
        public GetClientSetsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALClientSet> result = default(List<ALClientSet>))
        {
        ...
        public List<ALClientSet> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetClientSetsDefaultResponse {\n");
