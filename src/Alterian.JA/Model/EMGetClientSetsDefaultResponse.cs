...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EM_GetClientSets_default_response")]
    public partial class EMGetClientSetsDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EMGetClientSetsDefaultResponse" /> class.
        /// </summary>
        ...
        public EMGetClientSetsDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<DMClientSet> result = default(List<DMClientSet>))
        {
        ...
        public List<DMClientSet> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EMGetClientSetsDefaultResponse {\n");
