...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateEMSession_default_response")]
    public partial class CreateEMSessionDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEMSessionDefaultResponse" /> class.
        /// </summary>
        ...
        public CreateEMSessionDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), ApplicationDetails result = default(ApplicationDetails))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateEMSessionDefaultResponse {\n");
