...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueryEventStream_default_response")]
    public partial class QueryEventStreamDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryEventStreamDefaultResponse" /> class.
        /// </summary>
        ...
        public QueryEventStreamDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), QueryEventStreamResult result = default(QueryEventStreamResult))
        {
        ...
        public QueryEventStreamResult Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryEventStreamDefaultResponse {\n");
