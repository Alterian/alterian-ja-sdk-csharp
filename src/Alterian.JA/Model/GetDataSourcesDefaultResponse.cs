...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetDataSources_default_response")]
    public partial class GetDataSourcesDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetDataSourcesDefaultResponse" /> class.
        /// </summary>
        ...
        public GetDataSourcesDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<ALDataSource> result = default(List<ALDataSource>))
        {
        ...
        public List<ALDataSource> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetDataSourcesDefaultResponse {\n");
