...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetTokens_default_response")]
    public partial class GetTokensDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTokensDefaultResponse" /> class.
        /// </summary>
        ...
        public GetTokensDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), List<CMTokenInformation> result = default(List<CMTokenInformation>))
        {
        ...
        public List<CMTokenInformation> Result { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetTokensDefaultResponse {\n");
