...
namespace Alterian.JA.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueryEventStreamCount_default_response")]
    public partial class QueryEventStreamCountDefaultResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QueryEventStreamCountDefaultResponse" /> class.
        /// </summary>
        ...
        public QueryEventStreamCountDefaultResponse(string statusCode = default(string), string debugMessage = default(string), List<List<string>> detail = default(List<List<string>>), APICursor cursor = default(APICursor), double result = default(double))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryEventStreamCountDefaultResponse {\n");
